...
class IncomeExpenseServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'incomeexpense';
    ...
    public function register(): void
    {
        ...
        $this->app->bind(AccountHeadService::class, function ($app) {
            return new AccountHeadService($app->make(AccountHeadsRepository::class));
        });
