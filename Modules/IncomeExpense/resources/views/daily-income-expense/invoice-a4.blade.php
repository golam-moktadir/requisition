...
@section('content-body')        
    <div class="mt-2 p-3 card">
        ...
        <div class="col-11" id="voucher-to-print">
            <table style="width: 100%; border-collapse: collapse; border: 1.5px solid black; text-align: left; padding-left: 3px;">
                ...
                <tr style="background: #B2B2B2; color: #fff;">
                ...
                <tr>
                    <td style="width: 75%; padding-left: 15px; text-align: left; border-right: 1.5px solid;">
...
<script>
    function printDiv() {
        ...
        printWindow.document.write('<html><head><title>Voucher-No-{{ $invoice->id }}</title><style>@media print { body { -webkit-print-color-adjust: exact; print-color-adjust: exact; font-family: Arial, sans-serif; font-size: 12px; } table th { font-size: 16px; } table td { font-size: 14px; } }</style></head><body>');
