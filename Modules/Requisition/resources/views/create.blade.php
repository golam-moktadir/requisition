...
<div class="mt-1 p-2 card">
   ...
   <form action="{{ route('requisition.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row my-1">
         ...
         <div class="col-sm-6">
            <label for="purpose_id" class="form-label">Purpose Name <span class="text-danger">*</span></label>
      ...
      <div class="row my-1">
         <div class="col-sm-6">
            <label for="payee_id" class="form-label">Payee Name <span class="text-danger"></span></label>
